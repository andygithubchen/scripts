...
if ls -l ${conf_install_dir}/server/ |grep "5.3.18" > /dev/null;then
  ...
  if [ $machine == "x86_64" ];then
	  ...
	  mv ./ZendGuardLoader-php-5.3-linux-glibc23-x86_64/php-5.3.x/ZendGuardLoader.so ${conf_install_dir}/server/php/lib/php/extensions/no-debug-non-zts-20090626/
  else
	  ...
	  mv ./ZendGuardLoader-php-5.3-linux-glibc23-i386/php-5.3.x/ZendGuardLoader.so ${conf_install_dir}/server/php/lib/php/extensions/no-debug-non-zts-20090626/
  fi
  ...
  if [ $machine == "x86_64" ];then
	  ...
	  mv ./ZendGuardLoader-70429-PHP-5.4-linux-glibc23-x86_64/php-5.4.x/ZendGuardLoader.so ${conf_install_dir}/server/php/lib/php/extensions/no-debug-non-zts-20100525/
  else
	  ...
	  mv ./ZendGuardLoader-70429-PHP-5.4-linux-glibc23-i386/php-5.4.x/ZendGuardLoader.so ${conf_install_dir}/server/php/lib/php/extensions/no-debug-non-zts-20100525/
  fi
